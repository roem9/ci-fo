                    ...
                    foreach ($piutang as $piutang) :?>
                        <tr>
                            ...
                            <td><?=$piutang['nama_kpq']?></td>
                                    <td><center><a href="#" class="badge badge-danger modalInvoice" data-toggle="modal" data-target="#exampleModalScrollable" data-id="<?= $piutang['nip']?>"><?= $piutang['invoice']?></a></center></td>
    ...
    $(".modalInvoice").click(function(){
        ...
        $.ajax({
            ...
            success : function(data){
                $("#exampleModalScrollableTitle").html(data[0].nama_kpq);
                var html = '';
                var i;
