                        ...
                        <tbody>
                            ...
                            foreach ($piutang as $piutang) :?>
                                <tr>
                                    ...
                                    <td><center><a href="#" class="badge badge-danger modalInvoice" data-toggle="modal" data-target="#exampleModalScrollable" data-id="<?= $piutang['id_kelas']?>"><?= $piutang['invoice']?></a></center></td>
                                    <td class="bg-danger text-white"><?= rupiah($piutang['piutang'])?></td>
                                    <td><center><a href="<?=base_url()?>piutang/history/<?= $piutang['id_kelas']?>" class="badge badge-warning">pembayaran</a></center></td>
                                </tr>
                            <?php endforeach;?>
                        </tbody>
                    </table>
